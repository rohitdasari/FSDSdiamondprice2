...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            logging.info('Pipeline initiatied')
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ('ordinal encedor',OrdinalEncoder(categories=[cut_categories,color_categories,clarity_categories])),
                    ('scaler',StandardScaler())
                ]
            )
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info('applying preprocession object on training and testing dataset')
